...
import { ClienteFiltro } from '../models/cliente.model';
...
export class FuncionarioService {
	...
	list: BehaviorSubject<Funcionario[]> = new BehaviorSubject<Funcionario[]>([]);
	...
	getList() {
		...
		var list = JSON.parse((localStorage.getItem('clientes') ?? '[]')) as Funcionario[];
